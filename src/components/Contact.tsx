              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-center">
                    ...
                    <span className="ml-4 font-rajdhani">tracy@harrisondev.com</span>
                  </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="ml-4 font-rajdhani">San Francisco, CA</span>
                  </div>
                </div>
                
                <div className="mt-8 flex space-x-4">
                  {/* Github */}
                  <a href="#" className="w-10 h-10 rounded-md flex items-center justify-center bg-gradient-to-br from-black/80 to-black/40 border border-white/10 hover:border-neon-blue/50 transition-all duration-300 hover:shadow-[0_0_10px_rgba(0,240,255,0.3)]">
                  ...
                  {/* LinkedIn */}
                  <a href="#" className="w-10 h-10 rounded-md flex items-center justify-center bg-gradient-to-br from-black/80 to-black/40 border border-white/10 hover:border-neon-purple/50 transition-all duration-300 hover:shadow-[0_0_10px_rgba(159,0,255,0.3)]">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.968v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0v8.399h4.988v-10.131c0-7.88-8.922-7.593-11.018-3.714v-2.155z"/>
                    </svg>
                  </a>
                  {/* Twitter/X */}
                  <a href="#" className="w-10 h-10 rounded-md flex items-center justify-center bg-gradient-to-br from-black/80 to-black/40 border border-white/10 hover:border-neon-magenta/50 transition-all duration-300 hover:shadow-[0_0_10px_rgba(255,0,184,0.3)]">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
